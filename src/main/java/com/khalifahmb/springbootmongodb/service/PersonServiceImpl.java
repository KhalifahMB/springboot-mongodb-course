...
import com.khalifahmb.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService {
    ...
    public List<Document> getPopulationByCity() {
        ...
        // SortOperation sortOperationForAge = Aggregation.sort(Sort.Direction.DESC, "age");

        // GroupOperation groupOperation = Aggregation.group("addresses.city").count().as("popCount")
        //         .first(Aggregation.ROOT).as("oldestMember");
        ...
        // , sortOperationForAge
        , groupOperation,sortOperation, projectionOperation);
